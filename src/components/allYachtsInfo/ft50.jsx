    ...
    <div className="yachtInfo">
      ...
      <div className="yachtDetail">
        <div className="yachtImages">
          <img src={feet50_1} alt="50 feet image" />
          <img src={feet50_2} alt="50 feet image" />
          <img src={feet50_3} alt="50 feet image" />
          <img src={feet50_4} alt="50 feet image" />
          <img src={feet50_5} alt="50 feet image" />
          <img src={feet50_6} alt="50 feet image" />
          <img src={feet50_7} alt="50 feet image" />
          <img src={feet50_8} alt="50 feet image" />
          <img src={feet50_9} alt="50 feet image" />
          <img src={feet50_10} alt="50 feet image" />
          <img src={feet50_11} alt="50 feet image" />
          <img src={feet50_12} alt="50 feet image" />
          <img src={feet50_13} alt="50 feet image" />
          <img src={feet50_14} alt="50 feet image" />
          <img src={feet50_15} alt="50 feet image" />
          <img src={feet50_16} alt="50 feet image" />
          <img src={feet50_17} alt="50 feet image" />
          <img src={feet50_18} alt="50 feet image" />
          <img src={feet50_19} alt="50 feet image" />
          <img src={feet50_20} alt="50 feet image" />
          <img src={feet50_21} alt="50 feet image" />
        </div>
        <h1>Key Features of 50 Feet Mejesty Brand Yacht</h1>
        <h2>50 Feet Mejesty Brand Yacht</h2>
        <ul>
          <li>
